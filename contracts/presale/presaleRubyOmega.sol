...
// File: contracts/RubyNodeOmega.sol
...
/// @title Defo Ruby Omega Node Minting Contract
/// @notice Contract for minting ruby nodes
contract RubyNodeOmega is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private supply;

    bool public activeSale = false;
    uint64 public maxTotalRubyNodes = 70; // total supply of ruby nodes
    uint64 public maxNodesPerWallet = 5; // max number of ruby nodes one can hold per wallet
    uint256 public rubyNodePrice = 500; // the current price for minting a ruby node
    ...
    constructor(address DAI_address) ERC721("Defo Ruby Omega Node", "DRON") {
