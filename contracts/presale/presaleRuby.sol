...
contract RubyNode is ERC721Enumerable, Ownable {
    ...
    uint64 public maxNodesPerWallet = 10; // max number of ruby nodes one can hold per wallet
    uint256 public rubyNodePrice = 200; // the current price for minting a ruby node
    ...
    function mintNode() public payable {
        ...
        require(
            ...
            rubyNodePrice * DECIMAL_MULTIPLIER,
