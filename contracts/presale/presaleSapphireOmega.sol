...
// File: contracts/SapphireNodeOmega.sol
...
contract SapphireNodeOmega is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private supply;

    bool public activeSale = false;
    uint64 public maxTotalSapphireNodes = 140; // total supply of sapphire nodes
    uint64 public maxNodesPerWallet = 10; // max number of sapphire nodes one can hold per wallet
    uint256 public sapphireNodePrice = 125;
    ...
    ERC721("Defo Sapphire Omega Node", "DSON")
    {
