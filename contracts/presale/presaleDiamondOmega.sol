...
// File: contracts/DiamondNodeOmega.sol
...
/// @title Defo Diamond Omega Node Minting Contract
/// @notice Contract for minting diamond nodes
contract DiamondNodeOmega is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private supply;

    bool public activeSale = false;
    uint64 public maxTotalDiamondNodes = 35; // total supply of diamond nodes
    uint64 public maxNodesPerWallet = 1; // max number of diamond nodes one can hold per wallet
    uint256 public diamondNodePrice = 2000; // the current price for minting a diamond node
