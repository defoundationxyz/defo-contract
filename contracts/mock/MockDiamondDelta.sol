...
contract MockDeltaDiamond is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private supply;

    uint256 public diamondDeltaNodePrice = 1200;
    uint256 constant DECIMAL_MULTIPLIER = 10 ** 18;
    string private baseURI;
    IERC20 DAIToken;

    constructor(address DAI_address)
        ERC721("Defo Diamond Delta Node", "DDDN")
    {
    ...
    function mintNode(uint256 amount) public {
        ...
        //         (diamondDeltaNodePrice * DECIMAL_MULTIPLIER) * amount,
