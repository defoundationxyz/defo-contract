...
const func: DeployFunction = async hre => {
  const { deployer, team, treasury, vault, rewardPool } = await hre.getNamedAccounts();
  ...
  for (const privilegedAddress of [deployer, diamondDeployment.address, team, treasury, team, vault, rewardPool]) {
